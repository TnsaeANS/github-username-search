        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10">
              <h3 className="text-sm font-medium text-gray-400">Public Repositories</h3>
              <p className="mt-1 text-3xl font-bold text-fuchsia-300">{user.public_repos}</p>
            </div>
            <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10">
              <h3 className="text-sm font-medium text-gray-400">Followers</h3>
              <p className="mt-1 text-3xl font-bold text-fuchsia-300">{user.followers}</p>
            </div>
            <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10">
              <h3 className="text-sm font-medium text-gray-400">Following</h3>
              <p className="mt-1 text-3xl font-bold text-fuchsia-300">{user.following}</p>
            </div>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-3xl shadow-xl border border-white/10 overflow-hidden">
            <div className="px-6 py-4 border-b border-white/10">
              <h2 className="text-2xl font-bold text-fuchsia-300">Recent Repositories</h2>
              <p className="text-sm text-gray-400 mt-1">Showing {repos.length} most recently updated repositories</p>
            </div>
            <ul className="divide-y divide-white/10">
              {repos.map((repo) => (
                <li key={repo.id} className="px-6 py-4 hover:bg-white/10 transition">
                    ...
                    <div className="flex gap-4 text-sm">
                      <span className="inline-flex items-center text-gray-300">
                        <svg className="h-4 w-4 mr-1 text-yellow-300" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 1.944A11.954 11.954 0 012.166 5C2.056 5.649 2 6.319 2 7c0 5.225 3.34 9.67 8 11.317C14.66 16.67 18 12.225 18 7c0-.682-.057-1.35-.166-2.001A11.954 11.954 0 0110 1.944zM10 15a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
                        </svg>
                        {repo.stargazers_count}
                      </span>
                      <span className="inline-flex items-center text-gray-300">
                        <svg className="h-4 w-4 mr-1 text-blue-300" fill="currentColor" viewBox="0 0 20 20">
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#1B0535] via-[#2D0A4A] to-[#120218]">
        <div className="max-w-md w-full bg-white/5 backdrop-blur-md p-8 rounded-3xl shadow-xl border border-white/10 text-center">
          ...
          <p className="text-gray-300 mb-6">The GitHub user "{params.username}" doesn't exist or can't be accessed.</p>
          <Link
            href="/"
            className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-br from-fuchsia-500 to-purple-600 text-white font-medium hover:shadow-lg transition-all"
          >
